...
MODEL                   = wheel_leg
MODULES                 = wheel_leg_d9e82f16_1.c wheel_leg_d9e82f16_1_create.c wheel_leg_d9e82f16_1_setParameters.c wheel_leg_d9e82f16_1_asserts.c wheel_leg_d9e82f16_1_deriv.c wheel_leg_d9e82f16_1_checkDynamics.c wheel_leg_d9e82f16_1_compOutputsKin.c wheel_leg_d9e82f16_1_compOutputsDyn.c wheel_leg_d9e82f16_1_asm_delegate.c wheel_leg_d9e82f16_1_sim_delegate.c wheel_leg_d9e82f16_1_mode_zero_crossings.c wheel_leg_d9e82f16_1_geometries.c wheel_leg_d9e82f16_1_gateway.c pm_printf.c rt_logging.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c rtGetInf.c rtGetNaN.c rt_nonfinite.c wheel_leg.c wheel_leg_capi.c wheel_leg_data.c wheel_leg_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = wheel_leg.exe
MAKEFILE                = wheel_leg.mk
MATLAB_ROOT             = D:\matlab\installPositon
ALT_MATLAB_ROOT         = D:\matlab\INSTAL~1
MATLAB_BIN              = D:\matlab\installPositon\bin
ALT_MATLAB_BIN          = D:\matlab\INSTAL~1\bin
START_DIR               = D:\matlab\example\open_v2
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 39
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = wheel_leg_ref.rsp
COMPILER_COMMAND_FILE     = wheel_leg_comp.rsp
